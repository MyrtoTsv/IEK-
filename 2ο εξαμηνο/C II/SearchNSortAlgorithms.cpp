...
for (i=0; i<SIZE; i++)
{
printf("ÅéóÜãåôå ôï óôïé÷åßï  [%d] ôïý ðßíáêá: ", i+1);
scanf("%f", &matrix[i]);
}
system("CLS");
...
printf("\n\nÐïéï óôïé÷åßï øÜ÷íåéò ìÝóá óôïí ðßíáêá; ");
scanf("%f", &element);
...
if(position == -1)
printf("\nÔï óôïé÷åßï %.2f äåí õðÜñ÷åé óôïí ðßíáêá.\n", element);
else
printf("\nÔï óôïé÷åßï %.2f õðÜñ÷åé óôïí ðßíáêá óôç èÝóç %d.\n", element, position);
